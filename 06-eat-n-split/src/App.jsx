  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        <Button onClick={handleShowAddSFriend}>Add Friend</Button>
      </div>
...
function FormAddFriend({ setFriends, friends }) {
...
function FormSplitBill({ handleSplitBill, selectedFriend }) {
